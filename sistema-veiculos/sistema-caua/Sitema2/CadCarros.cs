...
namespace Sitema2
{
    public partial class CadCarros : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO tb_carros (Proprietario, Telefone, Cpf, Marca, Modelo, Placa, Ano, Chassi, Cor, Acessorios, Valor) VALUES (@Proprietario, @Telefone, @Cpf, @Marca, @Modelo, @Placa, @Ano, @Chassi, @Cor, @Acessorio, @Valor)";
